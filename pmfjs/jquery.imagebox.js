...
(function ($) {
    ...
    function initHtml(obj) {
        ...
        div.append('<div class="modal-dialog">' +
                ...
                '<div class="img-op">' +
                '<span class="btn btn-primary zoom-in">Agrandir</span>' +
                '<span class="btn btn-primary zoom-out">Réduire</span>' +
                '<span class="btn btn-primary rotate">Tourner</span>' +
                '<br>' +
                '<span role="prev" class="btn btn-primary switch">Précédent</span>' +
                '<span role="next" class="btn btn-primary switch">Suivant</span>' +
                '</div>' +
                '</div>' +
