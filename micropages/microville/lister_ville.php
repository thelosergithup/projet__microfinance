                        ...
                        <div class="main-sparkline13-hd">
                            ...
                            if (($_SESSION["roleuser"] == "administrateur") || ($_SESSION["roleuser"] == "Directeur Général Adjoint") || ($_SESSION["roleuser"] == "Directeur Général") || ($_SESSION["roleuser"] == "Directeur Administratif et Finance")) {
                                ...
                                <div class="add-product">
                                    <a href="<?= $url; ?>?page=<?php echo base64_encode('micropages/microville/ajouter_ville/ajout_ville'); ?>" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> Ajouter</a>
                                </div>
                                <?php
                            }
                            ?>
