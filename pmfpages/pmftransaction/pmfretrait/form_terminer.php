            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline12-list mt-b-30">
                        ...
                        <form id="ajout_utilisateur" name="formutilisateur" enctype="multipart/form-data" method="post" action="<?= $url; ?>?page=<?php echo base64_encode('pmfpages/pmfretrait/edit_retrait'); ?>&pagecom=<?php echo NUM_PAGE + 1; ?>" style="padding: 2%;">
