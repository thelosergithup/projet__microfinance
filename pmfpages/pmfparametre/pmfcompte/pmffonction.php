...
?>
        ...
        <tr>
            ...
            <td><?php print nl2br(htmlspecialchars($reccompte["loginclient"])) ?></td>
            ...
            <td>
                <!--                <a href="<?= $url; ?>?page=<?php //echo base64_encode('pmfpages/pmfparametre/pmfcompte/pmfediter/edit_compte'); 
                                                                ?>&idcompte=<? php // echo $reccompte["idcompte"]; 
                                                                            ?>" >
