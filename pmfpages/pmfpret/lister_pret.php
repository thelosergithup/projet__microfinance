    ...
    <div class="row">
        ...
        ?>
            ...
            <div class=" animated zoomIn">
                <div class="card">
                    <div type="hidden"> <?php //echo $rowp['iddemande']; 
                                        ?> </div>
                   ...
                   <button class="button button-close">Rejeter</button> -->
                    ...
                    <!--                    <a href="<?= $url; ?>?page=<? php // echo base64_encode('pmfpages/pmfpret/pmfdemandepret/demandepret_ajax'); 
                                                                        ?>" class="btn btn-danger btn-sm pull-center"><i class="glyphicon glyphicon"></i> Rejeter</a>
 -->
                </div>
