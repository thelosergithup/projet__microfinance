            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline12-list mt-b-30">
                        ...
                        <form id="edit_utilisateur" name="formutilisateure" enctype="multipart/form-data" method="post" action="<?= $url; ?>?page=<?php echo base64_encode('pmfpages/pmfutilisateur/pmfediter/edit_utilisateur'); ?>&idutilisateur=<?php echo $_REQUEST["idutilisateur"]; ?>&pagecom=<?php echo NUM_PAGE + 1; ?>" style="padding: 2%;">
                                        ...
                                        <div class="inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="rolee" id="rolee">
                                                    ...
                                                    <option value="Client" <?php if ($_SESSION['formutilisateure'][NUM_PAGE]["rolee"] == "Client ") { ?> selected <?php } ?>>Client</option>
                                                    <option value="Agent de credit" <?php if ($_SESSION['formutilisateure'][NUM_PAGE]["rolee"] == "Agent de credit") { ?> selected <?php } ?>>Agent de credit</option>
                                                    <option value="Caissière" <?php if ($_SESSION['formutilisateure'][NUM_PAGE]["rolee"] == "Caissière") { ?> selected <?php } ?>>Caissiere</option>
                                                    <option value="Directeur des Ressources Humaines" <?php if ($_SESSION['formutilisateure'][NUM_PAGE]["rolee"] == "Directeur des Ressources Humaines") { ?> selected <?php } ?>>Directeur Des Ressources humaines</option>
                                                    <option value="Gestionnaire" <?php if ($_SESSION['formutilisateure'][NUM_PAGE]["rolee"] == "Gestionnaire") { ?> selected <?php } ?>>Gestionnaire</option>
                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-8 col-xs-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4">
                                            <div class="form-group">
                                                <label class="control-label" >Num&eacute;ro CNI<g style="color: red">*</g></label>
                                                <div class="inputGroupContainer">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                        <input value="<?php echo $_SESSION['formutilisateure'][NUM_PAGE]["cnie"]; ?>" class="form-control" placeholder="" type="text" name="cnie" id="cnie" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    <div class="form-group">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            ...
                                            <img src="pmfupload/profil/<?php echo $_SESSION['formutilisateure'][NUM_PAGE]['photostring']; ?>" style="width: 20mm; height: 20mm;">
                ...
                logine: {
                    ...
                    validators: {
                        remote: {
                            ...
                            dataType: 'json',
                            url: './pmfcocogpages/pmfcocogutilisateur/remoteformvalidationutilisateur.php',
