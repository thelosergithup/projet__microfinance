...
switch (NUM_PAGE) {
    ...
    case 2:
        ...
        if ((isset($erreurprod)) && ($erreurprod)) {
            ...
            $pag = 'pmfpages/pmfutilisateur/pmfediterprofil/edit_utilisateur';
            $stag = 1;
            die('<meta http-equiv="refresh" content="0; URL='.$url.'?page=' . base64_encode($pag) . '&pagecom=' . $stag . '">');
            
        } else {
        require('pmfpages/pmfutilisateur/pmfediterprofil/form_terminer.php');
        break;
        }
    ...
    default:
        ...
        require('pmfpages/pmfutilisateur/pmfediterprofil/form_edit_utilisateur.php');
        break;
}
}