...
switch (NUM_PAGE) {
    ...
    case 2:
        ...
        if ((isset($erreurprod)) && ($erreurprod)) {
            $pag = 'pmfpages/pmfutilisateur/pmfajouter/ajout_utilisateur';
            $stag = 1;
            die('<meta http-equiv="refresh" content="0; URL='.$url.'?page=' . base64_encode($pag) . '&pagecom=' . $stag . '">');
            
        } else {
        require('pmfpages/pmfutilisateur/pmfajouter/form_terminer.php');
        break;
        }
    ...
    default:
        ...
        require('pmfpages/pmfutilisateur/pmfajouter/form_ajouter_utilisateur.php');
        break;
}